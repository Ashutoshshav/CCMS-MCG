...
namespace CCMS.Service
{
    public class ApplicationDbContext : DbContext
    {
        ...
        public DbSet<db_Live_info> db_Live_info { get; set; }
        public DbSet<Dashboardinfo> Dashboardinfo { get; set; }
        public DbSet<SiteSummary> SiteSummary { get; set; }
        public DbSet<ReportingEmails> ReportingEmails { get; set; }
    }
}
